...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function _print_webpage($data)
	{
		...
		#print-table table td ,th, #print-table table tr th{ border: 1px solid black; padding: 4px 8px 4px 4px}
		...
		$string_to_print .= '<table  style="direction:rtl; border:solid 0px; border-collapse:collapsed" border="0" width="100%" cellpadding="0" cellspacing="0" ><tr>';
		foreach($data->columns as $column){
