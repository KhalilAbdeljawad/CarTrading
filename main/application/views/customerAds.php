...
<div class="container">
    <div class="row">
        ...
        if (empty($searchResult))
            ...
            ?>
        <?php foreach ($searchResult as $car) { ?>

            <div class="col-lg-3 col-md-3 col-md-offset-0"><a
                        href="<?php print base_url() ?>Homepage/viewAd/<?php print $car->id ?>"><img
                            src="<?php print base_url() . "assets/uploads/files/" . $car->customer_id . "/" . $car->id . "/" . $car->main_image ?>"
...
<script>
    $(document).ready(function () {
        ...
        $("#maker").change(function () {
            ...
            $.post("getModels/" + $("#maker").val(), function (data) {
                $("#model").html(data);
